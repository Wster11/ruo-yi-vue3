...
export default [
  ...
  // 2. 获取分类下拉列表
  {
    url: '/dev-api/v1/device/categoryAll',
    method: 'get',
    response: () => {
      return {
        code: 200,
  ...
  // 3. 获取设备参数设置列表
  {
    url: '/dev-api/v1/device/getCategoryAttributeList',
    method: 'get',
    response: ({ query }) => {
  ...
  // 4. 查询设备型号列表
  {
    url: '/dev-api/v1/device/getDeviceModelList',
    method: 'get',
    response: ({ query }) => {
      const categoryId = parseInt(query.categoryId)
  ...
  // 5. 查询设备编码列表
  {
    url: '/dev-api/v1/device/getDeviceCodeList',
    method: 'get',
    response: ({ query }) => {
      const categoryId = parseInt(query.categoryId)
      const codeName = query.codeName
  ...
  // 6. 设备新增
  {
    url: '/dev-api/v1/device/add',
    method: 'post',
    response: ({ body }) => {
      console.log('新增设备请求参数:', body)
  ...
  // 7. 设备编辑
  {
    url: '/dev-api/v1/device/edit',
    method: 'put',
    response: ({ body }) => {
      console.log('编辑设备请求参数:', body)
  ...
  // 8. 设备删除
  {
    url: '/dev-api/v1/device/:id',
    method: 'delete',
    response: ({ query }) => {
      const deviceId = parseInt(query.id)
  ...
  // 9. 获取关联设备文件列表
  {
    url: '/dev-api/v1/device/getDeviceBindFileList',
    method: 'get',
    response: ({ query }) => {
  ...
  // 10. 获取文件列表（用于关联）
  {
    url: '/dev-api/v1/device/getDeviceFileList',
    method: 'get',
    response: ({ query }) => {
      const fileName = query.fileName
      const fileType = query.fileType
      const fileLanguage = query.fileLanguage
  ...
  // 11. 确认关联文件
  {
    url: '/dev-api/v1/device/bindSelectFile',
    method: 'post',
    response: ({ body }) => {
      console.log('关联文件请求参数:', body)
      ...
      return {
        ...
        data: {
          ...
          bindCount: body.fileIds ? body.fileIds.length : 0
        }
      }
    }
  },
  ...
  // 12. 获取语言列表
  {
    url: '/dev-api/v1/device/geLanguageList',
    method: 'get',
    response: () => {
      return {
        code: 200,
  ...
  // 13. 获取文档类型列表
  {
    url: '/dev-api/v1/device/getDocumentTypeList',
    method: 'get',
    response: () => {
      return {
        code: 200,
  ...
  // 14. 批量上传文件
  {
    url: '/dev-api/v1/device/uploadFileList',
    method: 'post',
    response: ({ body }) => {
      console.log('批量上传文件请求参数:', body)

      const fileCount = body.files ? body.files.length : 0
